...
namespace Demo\Bundle\ShippingTableRatesBundle\Migrations\Schema\v1_0;

use Doctrine\DBAL\Schema\Schema;
use Oro\Bundle\MigrationBundle\Migration\Migration;
use Oro\Bundle\MigrationBundle\Migration\QueryBag;

class DemoShippingTableRatesBundle implements Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Add `demo_ship_tbl_rates_trans_label` foreign keys.
     *
     * @param Schema $schema
     */
